...
# load the stan files
wb1 <- stan_model("stan_final/wb1.stan")
wb2 <- stan_model("stan_final/wb2.stan")
wb3 <- stan_model("stan_final/wb3.stan")
wb4 <- stan_model("stan_final/wb4.stan")

ln1 <- stan_model("stan_final/LN1.stan")
ln2 <- stan_model("stan_final/LN2.stan")
ln3 <- stan_model("stan_final/LN3.stan")
ln4 <- stan_model("stan_final/LN4.stan")

llg1 <- stan_model("stan_final/LLG1.stan")
llg2 <- stan_model("stan_final/LLG2.stan")
llg3 <- stan_model("stan_final/LLG3.stan")
llg4 <- stan_model("stan_final/LLG4.stan")



# Extract posterior summaries from each fitted model
