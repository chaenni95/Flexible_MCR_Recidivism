...
wb_stan <- stan_model("stan_final/wb2.stan")
wb_stan_fit <- sampling(wb_stan, data = iowa18_stan, seed = 12345, chains = 4, iter = 2000, init = 0,
                          pars = c("betaU", "betaC", "sigma", "alpha_s", "lp__", "log_lik"))

saveRDS(wb_stan_fit, "results/data_result/wb2.rds")
