...
ln_stan <- stan_model("stan_final/LN2.stan")
ln_stan_fit <- sampling(ln_stan, data = iowa18_stan, seed = 12345, chains = 4, iter = 2000, init = 0,
                          pars = c("betaU", "betaC", "sigma", "alpha_s", "lp__", "log_lik"))

saveRDS(ln_stan_fit, "results/data_result/ln2.rds")
